...
docker compose \
  --file /opt/superset-cluster/mysql-mgmt/docker_compose.yml up initcontainer \
&& \
docker compose \
  --file /opt/superset-cluster/mysql-mgmt/docker_compose.yml up maincontainer \
  --detach
